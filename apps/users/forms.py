...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'email', 'phone', 'image', 'gender', 'dob', 'user_type',
                  'user_type', 'is_verified', 'is_admin', 'is_active',
                ]
        ...
        widgets = {
            ...
            'user_type': Select(attrs={'class': 'form-select js-choice'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Exclude 'admin' option from user_type field choices
        self.fields['user_type'].choices = [
            choice for choice in self.fields['user_type'].choices
            if choice[0] != User.UserType.ADMIN
        ]
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'email', 'phone', 'image', 'user_type', 'is_verified', 'is_admin', 'address']
...
class UserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = [
            'first_name', 'last_name', 'email', 'phone', 'image', 'dob', 'gender', 'address',
        ]
